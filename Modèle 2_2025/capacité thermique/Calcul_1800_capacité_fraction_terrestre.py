...
for i in df_cells.index:
    ...
    soil_frac = df_cells.at[i, "soil_frac"] / 100
    ice_frac = df_cells.at[i, "ice_frac"] / 100
...
df_cells["heat_capacity_J_per_K"] = heat_capacities
# Sauvegarder le fichier CSV avec les colonnes demandées
df_cells[["latitude", "longitude", "heat_capacity_J_per_K"]].to_csv("capacite_thermique_par_cellule.csv", index=False)