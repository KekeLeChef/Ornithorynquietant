...
if __name__ == "__main__":
    ...
    _, T0 = calc_power_temp(0,10, sun_vector, x, y, z, phi, theta,
    ...
    with Pool(processes=cpu_count()) as pool:
        ...
        for i in range(1, 601):
            P, _ = calc_power_temp(i,10, sun_vector, x, y, z, phi, theta,
                                   constante_solaire, sigma, rayon_astre, list_albedo, latitudes, longitudes)
            P_flat = P.flatten()
        ...
        for h in range(1, 25):
            P, _ = calc_power_temp(h, 10, sun_vector, x, y, z, phi, theta,
                                   constante_solaire, sigma, rayon_astre, list_albedo, latitudes, longitudes)
            P_flat = P.flatten()
...
if __name__ == "__main__":
    ...
    # Sauvegarde CSV
    np.savetxt("Octobre.csv", temperature_matrix, delimiter=",")
