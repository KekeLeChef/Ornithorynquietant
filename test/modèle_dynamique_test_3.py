...
import shapefile
import pandas as pd
from fonctions_modifie import update_sun_vector, project_to_sphere, get_shape, get_albedo, calc_power_temp, update_plot, slider_update, set_mois, temp_dans_csv
import csv
